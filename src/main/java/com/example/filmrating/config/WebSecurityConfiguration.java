...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("api/not-authenticated", "/api/v1/account/create", "/api/v1/account/active/*", "/api/v1/auth/login-basic-v2"
                        , "/api/v1/auth/login-jwt", "/api/v1/film/search", "/api/v1/review/find-by-film",
                        "/api/v1/film/get-by-id").permitAll()
        ...
        // Khai báo lớp filtersex được thực hiện trước khi authen và author
